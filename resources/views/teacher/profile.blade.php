        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-4">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=2563EB&color=fff&size=80&bold=true" 
                         alt="{{ $user->name }}" 
                        ...
                        <form method="post" action="{{ route('profile.update') }}" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 text-sm font-bold border border-blue-100 w-full">
                                        Teacher
                                    </span>
                                </div>
                            </div>
