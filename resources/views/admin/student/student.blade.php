                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-3">
                                        <a href="#" class="text-gray-400 hover:text-blue-600 transition-colors" title="View">
                                        ...
                                        <a href="#" class="text-gray-400 hover:text-green-600 transition-colors" title="Edit">
