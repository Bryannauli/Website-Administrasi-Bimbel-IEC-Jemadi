<x-app-layout>
    ...
    <div class="flex items-center gap-2 text-sm text-gray-600 ml-6 mt-6">
        ...
        <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
                d="M7.293 14.707a1 1 0 010-1.414L10.586 10 
                   7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                clip-rule="evenodd" />
        </svg>
        ...
        <span class="text-gray-900 font-medium">Edit Student</span>
    </div>
            ...
            <form action="{{ route('admin.student.update', $student->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="address" class="w-full border rounded p-2">{{ old('address', $student->address) }}</textarea>
                    </div>
                ...
                {{-- Submit --}}
                <button class="bg-blue-600 text-white px-4 py-2 rounded mt-5 hover:bg-blue-700">
                    Update Student
                </button>
            </form>
        </div>
