<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- BREADCRUMB (DYNAMIC: Dashboard > Students > [Optional: Detail] > Edit) --}}
            <nav class="flex mb-5" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    {{-- 3. Student Details (CONDITIONAL: HANYA MUNCUL JIKA DARI DETAIL) --}}
                    @if(request('ref') == 'detail')
                        <li>
                            <div class="flex items-center">
                                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                                {{-- Link balik ke halaman Detail --}}
                                <a href="{{ route('admin.student.detail', $student->id) }}" class="ml-1 text-sm font-medium text-gray-500 hover:text-blue-600 md:ml-2">
                                    Student Details
                                </a>
                            </div>
                        </li>
